...
const routes: Routes = [
  ...
  { path: "user/settings", component: UserDashboardComponent, pathMatch: "full"},
  ...
  { path: "user/"+RouteNames.NOTIFICATIONS, component: NotificationsPageComponent, pathMatch: "full" },
  ...
  // logged in users profile -- shivam added
  {
    path: "user/" + RouteNames.FOLLOWERS,
    component: ManageLoggedInUsersFollowsPageComponent,
    pathMatch: "full",
  },
  {
    path: "user/" + RouteNames.FOLLOWING,
    component: ManageLoggedInUsersFollowsPageComponent,
    pathMatch: "full",
  },
