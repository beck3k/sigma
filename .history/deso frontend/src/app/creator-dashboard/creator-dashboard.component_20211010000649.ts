...
export class CreatorDashboardComponent implements OnInit {
  ...
  resetStreamKey() {
    ...
    {username: this.globalVars.loggedInUser.ProfileEntryResponse.Username, publicKey: this.globalVars.loggedInUser.PublicKeyBase58Check }).subscribe((data: {streamKey}) => {
    console.log(data)
