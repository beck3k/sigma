...
export class CreatorDashboardComponent implements OnInit {
  ...
  updateStreamInfo() {
    this.backendApi.jwtPost('http://149.159.16.161:3123', `stream/${this.streamerProfile.PublicKeyBase58Check}/info`, this.globalVars.loggedInUser.PublicKeyBase58Check, {
