 ...
 streamers
  ngOnInit(): void {
    ...
    var player = new Clappr.Player({
      parentId: "#video",
      source: `http://149.159.16.161:8082/live/${this.streamers.streams[0].id}/index.m3u8`,
      width:"100%",
      height:"100%",
      playback: {
        hlsjsConfig: {
    ...
    console.log(`http://149.159.16.161:8082/live/${this.streamers.streams[0].id}/index.m3u8`)
