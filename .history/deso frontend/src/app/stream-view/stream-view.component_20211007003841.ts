...
export class StreamViewComponent implements OnInit {
  ...
  followedStreamers() {
    this.http.get(`http://149.159.16.161:3123/following/${this.globalVars.loggedInUser.PublicKeyBase58Check}`).subscribe((data)=>{this.followedStreamersList=data; console.log(this.followedStreamersList)})
  }
