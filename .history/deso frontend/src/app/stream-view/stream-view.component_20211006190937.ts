...
export class StreamViewComponent implements OnInit {
  ...
  getStreamer() {
    ...
    //     console.log(res)
    //   });
    this.http.get(`https://api.desofirehose.com/api/v0/get-single-profile-picture/${this.streamer.streams[0].publicKey}?fallback=https://bitclout.com/assets/img/default_profile_pic.png`).subscribe((res)=>this.streamerProfilePicture=res)
